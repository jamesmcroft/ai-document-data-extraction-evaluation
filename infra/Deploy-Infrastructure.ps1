<#
.SYNOPSIS
    Deploys the core infrastructure for the AI Document Data Extraction Evaluation to an Azure subscription.
.DESCRIPTION
...
.EXAMPLE
    .\Deploy-Infrastructure.ps1 -DeploymentName "ai-doc-eval" -Location "swedencentral"
.NOTES
    Author: James Croft
#>
